...
Param(
    ...
    [string] $StorageContainerName = $ArtifactStagingDirectory.ToLowerInvariant() + '-stageartifacts',
...
if ($UploadArtifacts -Or (Get-Member -InputObject $TemplateJSON.parameters -Name ArtifactsLocation -MemberType Properties) -ne $null) {
...
if ($ValidateOnly) {
    ...
    #$OptionalParameters[$ArtifactsLocationSasTokenName].ToString()
